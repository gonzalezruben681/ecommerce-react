...
function SignIn() {
  ...
  const renderCreateUserInfo = () => {
    return (
      <form ref={form} className="flex flex-col gap-4 w-80">
        ...
        <Link to="/">
          <button className="bg-black text-white w-full rounded-lg py-3" onClick={() => createAnAccount()}>Create</button>
        </Link>
      </form>
    );
  };
  ...
  return (
    <Layout>
      <h1 className="font-medium text-xl text-center mb-5 w-80">Welcome</h1>
      {renderView()}
    </Layout>
  );
}
